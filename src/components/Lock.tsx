    ...
    <AnimatePresence>
      {on && (
        ...
        >
          ...
          >
            <p className="lock__label t-label">Sessão bloqueada</p>
          ...
          >
            ...
            <div className="lock__user">
              ...
              <span className="lock__host t-mono">@helvetia</span>
            </div>
            ...
            <p className="lock__hint t-mono">
              qualquer senha entra — não há nada aqui para trancar
            </p>
          </motion.form>

          <div className="lock__foot t-mono">
            <span>helvetia 1.0 · wayland</span>
